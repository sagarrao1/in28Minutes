...
//        inheritance_ObjectReferences();
    ...
    private static void inheritance_FlightReference() {
        System.out.println("***************************");
        System.out.println("Inheritance - CargoFlight instance assigned to Flight reference");
        System.out.println();
...
//        System.out.println();
    ...
    private static void inheritance_Equals() {
        ...
        if(f1.equals(p1))
        	System.out.println("Flight and Passanger equal");
        else
            System.out.println("Flight and Passanger are NOT equal");
