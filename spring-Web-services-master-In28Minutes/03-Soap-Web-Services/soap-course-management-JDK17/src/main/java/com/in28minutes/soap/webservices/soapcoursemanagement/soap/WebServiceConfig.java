...
public class WebServiceConfig extends WsConfigurerAdapter{
	...
	public Wss4jSecurityInterceptor securityInterceptor() {
		...
		System.out.println("sagar:  securityInterceptor");
		securityInterceptor.setSecurementPassword(WSConstants.PW_NONE);
		securityInterceptor.setSecurementUsername(WSConstants.USERNAME_LN);
	...
	public SimplePasswordValidationCallbackHandler callbackHandler() {
		...
		System.out.println("sagar:  callbackHandler");
